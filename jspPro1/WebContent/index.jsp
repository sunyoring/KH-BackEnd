...
<body>
<h1>JSP</h1>
	<p> JSP 란 , HTML 형식내에서 자바코드를 사용할수 있는 "자바언어 "로<br>
		서블릿(java코드) 내에서 응답화면 (html)을 구현했던 복잠함을 보다 간단하게 작성, 해결할수있다. 
		-> 즉, JSP 의 가장 큰 장점은  Servlet에서는 비지니스 로직처리에만 집중하고 응답화면을 
		   만들어 내는 것은 JSP 에서 작성 하게끔 분리할 수 있다. 
	
	</p>
	<h1>JSP Elements 표현법</h1>
	<p> JSP 페이지에 자바코드를 직접 기술할수 있게 해주는 기능 </p>
	<ol>
		<li> 선언문 : &lt;%! 자바코드   %&gt; 
	...
	<h3><a href="views/03_menu.jsp">테스트3</a></h3>
</body>
</html>